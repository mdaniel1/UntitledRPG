...
public class ItemList {
    ...
    public static final Item MEDIUM_HEALTH_POTION = new Item("health potion", "I_M_HEALTH_POTION", "a", 40){
        int restoredHP = 50;
    ...
    public static final Item BIG_HEALTH_POTION = new Item("big health potion", "I_B_HEALTH_POTION", "a", 145){
        int restoredHP = 200;
